...
<html lang="en">
  <head>
    ...
    <title class="text-black">Notes App</title>
    @vite(['resources/css/app.css','resources/js/app.js'])
  </head>
  <body class="antialiased bg-gray-50">
    <div class="min-h-screen flex">
      <!-- Sidebar -->
<aside class="w-64 bg-gray-900 text-black h-screen flex flex-col">
    <div class="p-4 text-xl font-bold border-b border-gray-700 text-black">
        NotesApp
    </div>
